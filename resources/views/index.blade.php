...
@section('content')
<div class="hero text-center text-white d-flex align-items-center" style="min-height: 60vh; background: url('{{ asset('assets/NIKE_P_6000.jpg') }}') center center / cover no-repeat;">
    <div class="container">
