...
<body>
    ...
    <header class="absolute inset-x-0 top-0 z-50">
        ...
        <div class="hidden lg:flex lg:gap-x-12">
            <a href="#" class="text-sm/6 font-semibold text-white">Homepage</a>
        </div>
        <div class="hidden lg:flex lg:flex-1 lg:justify-end">
            ...
            <button id="btn-theme" class="btn btn-outline-dark rounded-pill btn-sm">🌙 Mode Gelap</button>
             <a href="{{ route('logout') }}" class="btn btn-danger rounded-pill btn-sm ms-4">Logout</a>
        </div>
        </div>
        </nav>
    </header>
    ...
    <div class="relative isolate px-6 pt-14 lg:px-8">
     ...
     <div class="rate" style="padding: 3rem; width: 80%; margin: auto;">
        <div class="row">
        ...
        <div class="container mx-auto px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                ...
                <div class="col-span-1 md:col-span-1">
                    <h3 class="text-white text-lg font-bold mb-4">Bubu Shoes</h3>
                    <p class="text-sm text-gray-400">
                        Menyediakan sepatu berkualitas terbaik dengan desain modern untuk kenyamanan langkah Anda sehari-hari.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm">
                        <li><a href="#" class="hover:text-white transition-colors">Homepage</a></li>
                ...
                <div>
                    <h3 class="text-white text-lg font-bold mb-4">Kategori</h3>
                    <ul class=" text-sm">
                ...
                <div>
                    ...
                    <ul class="text-sm text-gray-400">
                        <li>Jl. Sepatu No. 123, Jakarta</li>
                        <li>support@bubushoes.com</li>
            ...
            <div class="border-t border-gray-800 pt-8 mt-8 text-center">
                <p class="text-xs text-gray-500">&copy; 2024 Bubu Shoes Inc. All rights reserved.</p>
            </div>
        </div>
    </footer>
